				...
				<div class="row">
					<div class="large-8 columns">
						...
						<fieldset class="bio">
							...
							<legend class="legend">Apply for a job</legend>
							...
							<div class="row">
								...
								<div class="large-5 medium-5 small-6 columns">
									<img src="images/applyicon.jpg" height="150" width="150">
												...
												<div class="large-12 columns">
													...
													<table>
														...
														<col span= "6" style="background-color:#FDEEF4">
														  ...
														  <tr>
														<td>Actor</td>
														   <td>BLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLABLA BLA</td>
					...
					<fieldset class="bio">
								...
								<div class="row">
									<div class="large-12 large-offset-2 columns">
										<img src="images/adv1.jpg" height="80" width="80">
									</div>
								</div>
								<div class="row">
									<div class="large-12 large-offset-2 columns">
				...
				<div class="row">
					<div class="small-6 medium-6 large-6 columns">	
						<fieldset class="bio">
							...
							<legend class="legend">View Trailers</legend>
							...
							<div class="row">
								...
								<div class="large-6 medium-6 small-6 columns">
									<img src="images/trailer.jpg" height="150" width="150">
								</div>								
							</div>
												...
												<div class="large-6 columns">
												  <label>Breaking Bad
													<div class="flex-video">
														<iframe width="140" height="35" src="//www.youtube.com/embed/HhesaQXLuRY" frameborder="0" allowfullscreen></iframe>
													</div>
													<p class="fontsize"> A chemistry teacher diagnosed with a terminal lung cancer, teams up with his former student, Jesse Pinkman, to cook and sell crystal meth. </p>
												  </label>
												</div>
												<div class="large-6 columns">
												  <label>Dumb and Dubmer 2 
													<div class="flex-video">
														<iframe width="140" height="35" src="//www.youtube.com/embed/HMxwcRck9TI" frameborder="0" allowfullscreen></iframe>
													</div>
													<p class="fontsize"> 20 years since their first adventure, Lloyd and Harry go on a road trip to find Harry's newly discovered daughter, who was given up for adoption.</p>
												  </label>
												</div>
											  </div>
									  <a class="close-reveal-modal">&#215;</a>
						...
						<fieldset class="bio">
							...
							<div class="row">
								...
								<div class="large-6 medium-6 small-5 columns">
									<img src="images/newsfeed.jpg" height="150" width="150">
								</div>								
							</div>
